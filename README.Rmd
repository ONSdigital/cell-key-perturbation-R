...
This is an example which showing how to create a perturbed table from data included in this package in order to showcase the method. 

micro is an example dataset containing randomly generated data.

ptable_10_5 is an example ptable containing the rules to apply cell key perturbation with a threshold of 10 and rounding to base 5.
